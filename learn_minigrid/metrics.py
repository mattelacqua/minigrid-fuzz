...
class EvaluationLogger:
    def __init__(self, save_dir, eval_mode = False):
        ...
        with open(self.save_log, "w") as f:
            f.write(
                ...
                f"{'MedianReward':>15}{'MaxReward':>15}{'MeanLength':>15}\n"
            )
    ...
    def log_evaluation_cycle(self, agent, old_exp_rate):
        ...
        # print(mean_ep_reward, " ", mean_ep_length)
        with open(self.save_log, "a") as f:
            f.write(
                f"{agent.curr_episode:8d}{agent.curr_step:8d}{old_exp_rate:10.3f}"
